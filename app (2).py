...
administrative_duration = st.number_input("Administrative Duration", min_value=0.0, value=20.0)
informational = st.number_input("Informational Pages", min_value=0, value=1)
informational_duration = st.number_input("Informational Duration", min_value=0.0, value=5.0)
product_related = st.number_input("Product Related Pages", min_value=0, value=50)
product_related_duration = st.number_input("Product Related Duration", min_value=0.0, value=1000.0)
bounce_rates = st.number_input("Bounce Rate", min_value=0.0, max_value=1.0, value=0.02)
exit_rates = st.number_input("Exit Rate", min_value=0.0, max_value=1.0, value=0.05)
...
# Structure DataFrame to match training layout exactly
